...
_FuncPointer: TypeAlias = "_FuncPointer"

_ENUMRESTYPEPROC: _FuncPointer = ctypes.WINFUNCTYPE(BOOL, HMODULE, LPVOID, LONG_PTR)
_ENUMRESNAMEPROC: _FuncPointer = ctypes.WINFUNCTYPE(BOOL, HMODULE, LPVOID, LPVOID, LONG_PTR)
_ENUMRESLANGPROC: _FuncPointer = ctypes.WINFUNCTYPE(
